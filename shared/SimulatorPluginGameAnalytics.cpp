// ----------------------------------------------------------------------------
// 
// SimulatorPluginGameAnalytics.cpp
// Copyright (c) 2012 Corona Labs Inc. All rights reserved.
// 
// ----------------------------------------------------------------------------

#include "SimulatorPluginGameAnalytics.h"
...
CORONA_EXPORT int CoronaPluginLuaLoad_simulator_plugin_gameanalytics( lua_State * );
...
int luaopen_plugin_library( lua_State *L )
{
	...
	lua_CFunction factory = Corona::Lua::Open< CoronaPluginLuaLoad_simulator_plugin_gameanalytics >;
